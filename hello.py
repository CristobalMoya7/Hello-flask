from flask import Flask,render_template # Importamos la libreria de flask

# Inicializar el servidor de flask
# En windows: set FLASK_APP=hello.py        En mac: export FLASK_APP=hello.py
...
# Comando especial para lanzar el servidor en un puerto diferente, esto se usa en el caso de que el puerto 5000 este ocupado
#flask --app hello run -p 5001

# Para que se este actualizando todo el rato con otro puerto seria
